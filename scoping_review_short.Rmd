...
In recent years, the interest in alternative ways of social organization increased drastically due to the social and ecological crises we are facing [@Euler2018]. Commons are one of these alternatives, since they are a way of organizing resources beyond the classic private and public model [@Ostrom1990], and, therefore, they represent an option to the capitalistic system [@Euler2019]. For this reason, commons could be an integral part of the path to attain a more sustainable and fair social organization [@Schmelzer2022].

Commons have been defined in different ways, starting by Elinor Ostrom who, in her seminal work, refers to them as a resource system shared between a self-managed community of users [@Ostrom1990]. This community shares a set of social practices, values and norms. Therefore, it is important to consider the commons not only as a resource, but as the integration of the resource, the community and its social protocols [@Bollier2014]. For this reason, beyond the material aspect, the notion of social practices (i.e. commoning) is essential [@Euler2018]. "Commoning" refers to the process through which people (i.e. the commoners) find solutions for their needs by self-organizing independently from the state or the market, and by creating autonomously managed institutions to govern the shared resource [@Euler2018; @Schmelzer2022]. The community is therefore engaged in defining rules to successfully manage the commons [@Meroni2022]. In conclusion, commons can be understood as "living social systems" that allow commoners to self-organize to address shared problems [@Bollier2019].

These definitions highlight the importance of the community as a part of the commons, and that is why it is essential to have a closer look at the people who form it. More specifically, in order for a commons[^1] to be successful, its members have to cooperate, i.e to incur a personal sacrifice for the greater good [@Kollock1998]. Although it is essential, cooperation can be difficult to achieve due to two characteristics of the commons' social dynamic. First, people can believe that their individual contribution will not have a big impact, and this feeling of personal inefficacy discourages cooperation [@VanVugt1998]. Secondly, in a commons, every member faces a conflict between individual, short-term interests and collective, long-term ones [@Hardin1968]. Act for the common good requires a personal sacrifice, and therefore the temptation to pursue the individual interest is constantly present. For these reasons, we need to understand the factors that affect cooperation, and how we can improve it.
...
Cooperation can be modified by introducing incentive systems, that can be either punishments or rewards. Both have a positive effect on cooperation [@Balliet2011a]. However, some studies found that punishments are more efficient than rewards [e.g. @Milinski], while others came to the opposite conclusion [e.g. @Chen2022].
