...
In general, social identity seems to have a positive and largely observed effect on individuals' cooperation. This is due to the fact that humans have a very developed sense of belonging to social groups, and that this has an impact on their willingness to help other members of their group [@VanVugt]. Since priming a common social identity is quite simple (e.g. @Kramer1984; @Zhang2019), this could be a very powerful method to enhance cooperation in an easy and cheap way.
