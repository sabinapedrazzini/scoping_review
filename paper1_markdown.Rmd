...
At a certain point say that these factors are not independent, but interconnected =\> prepare a model/framework
...
@Navarro-Carillo2018: high status more generalized trust, low status more in-group depersonalized trust (because more social networks)
