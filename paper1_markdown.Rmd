...
Many societal problems that humans are facing nowadays have a social dilemma structure [@Kollock1998], i. e. they are situations in which short-term, individual interests are at odds with long-term, collective ones [@Hardin1968]. More specifically, each individual obtains a higher personal payoff with a non-cooperative, self-interested behaviour than with a social, cooperative one, independently from what others do. However, everybody's payoff is higher if all cooperate than if all defect [@Dawes1980].

An example of real-life social dilemma is the climate crisis that we are actually facing: engaging in pro-environmental behaviours to reduce our ecological footprint is often more complicated and less advantageous than acting without worrying about environment [@Griskevicius2010]. However, since behaviours that serve our personal well-being tend to be detrimental to the environment [@VanLange1998], if everyone defects by choosing the easy way, consequences will be (and already are) catastrophic. Another (less tragic) example is provided by @Kollock1998 and involves public television: the best outcome at the individual level would be to have access to the programs without paying the fee, but if nobody paid it, public television would no longer exist. Cooperation (i.e. sacrificing for the grater good at a personal cost, [@Kollock1998]) is therefore essential to avoid the worst collective outcome in social dilemma situations, and that is why a deep comprehension of this phenomenon is needed.

Classical economic theories have described human being as "homo economicus". This means that, facing a choice, individuals are considered as completely rational and always maximizing (expected) utility [@Edwards1954]. Therefore, according to these theories, individuals are not supposed to show altruistic behaviours, defined as behaviours that involve costs for the self while benefiting others [@Wittek2015]. Instead, the evolutionary perspective suggests that individuals can cooperate when doing so bring them a personal advantage. For example, the theory of competitive altruism [@Roberts1998] says that acting for the others' good could be a signal of a person's prosociality, and therefore improve this person's reputation. Moreover, the capacity to endorse a personal cost communicates strength and wealth, socially valued characteristics [@Zahavi1995]. In sum, according to economic and evolutionary theories, individuals are always pursuing their self-interest.

However, in social dilemma experiments, a significant amount of people are "strong reciprocators": they are willing to use their personal resources to "be kind to those who are being kind and to punish those who are being unkind", even if they are not certain that their altruistic behaviour will be rewarded [@Fehr2002; @Gachter2009]. This shows that cooperation is not always driven by personal interest and that people care about others' and environment's welfare[@Torsvik2011; @VanVugt2009]. In addiction to that, there are evidences suggesting that people do not always thoroughly analyze the context to take a rational cooperative or non-cooperative decision. In fact, cooperation seems to be the intuitive option in social dilemma experiments, while defection needs more thinking [@Kieslich2014]. Moreover, people can also cooperate in part because they are confused about the situation [@Andreoni1995]. Therefore, people are not always rational in the economic, individualistic way [@Kollock1998], and there are multiple factors that can influence their behaviour in social dilemmas situations [for a review, see @VanLange2013].
...
In general, incentives seem to be a powerful tool to enhance cooperation, but they have a dark side. In fact, they reduce participants' intrinsic motivation [@VadDijk2015], by framing the situation as an economic, rather than ethical, dilemma [@VanVugt2009]. Also, when incentives are present people think that others cooperate just because of them, and this undermines their trust in other members[@Irwin2014], and especially the trust in the fact that others are internally motivated to cooperate [@Mulder2006]. Therefore, if incentives are removed, cooperation drops [@Irwin2014; @Mulder2006].
...
opposite to hypothesis: anticipating a discussion reduced contributions to a public good (social norm enhanced by anticipating a discussion is probably one of conditional cooperation and not of inconditional cooperation =\> cond coop is also a moral norm)

in a PGG, people are also confused and make random choice: forcing to think about a discussion lead them to reflect more on the situation and act more rational + if the norm is of conditional cooperation, then rational = do not cooperate

study 2: if participants are told that they're part of a social group and that those who don't contribute are free-riders, anticipating a discussion increased contributions

if a discussion is announced, labelling defectors as free-riders has a big impact = communicates that there is a normative expectation to cooperate, so so anticipating a discussion enhances a norm of unconditional cooperation

@Balliet2010:

\- overall strong and positive effect of communication on cooperation

\- stronger effect for the talking (vs written) communication =\> more norms during face-to-face + nonverbal communication (video or phone calls also have this effect)

\- no difference of the effect if the communication was prior (vs during) the game, both are effective: communication before can create a social norm of keeping promise that sustain cooperation even if the communication is interrupted

\- communication has a stronger effect on bigger (vs smaller) groups: big group = less cooperation, communication buffers this negative effect + evolutionary theories = more efficient to send a generosity signal if many (vs few) others are present

@Bicchieri2002: norms are more important than group identity to explain the benefits of communication on cooperation

@Kumakawa2013: just knowing that ex-post communication will be possible does not affect cooperation, but receiving an actual feedback does + negative feedback increased cooperation, while positive ones had no effect

@Feinberg2014: gossip increased cooperation, especially when ostracize a person based on gossip content was possible, by facilitating partner selection

@Giardini2021: gossip can also be a way to increase own reputation (by telling the truth)

@Adams2022: qualitative analysis of communication contents in social dilemma --\> see page 29 of the paper to see which contents are associated with (un)successful groups
