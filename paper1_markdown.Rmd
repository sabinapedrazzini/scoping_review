...
@Torsvik2011: in the introduction says that people in social dilemma are confused and can make random choices = argument against the completely rational human (see wich papers they cited)
doi:10.1098/rstb.2010.0135: in the introduction they cite papers that have observed cooperation
...
In general, social identity seems to have a positive and largely observed effect on individuals' cooperation. This is due to the fact that humans have a very developed sense of belonging to social groups, and that this has an impact on their willingness to help other members of their group [@VanVugt]. Since priming a common social identity is quite simple (e.g. @Kramer1984; @Zhang2019), this could be a very powerful technique to enhance cooperation in an easy and cheap way.

## Personal values and attitudes

Personality plays a substantial role in predicting cooperation [@Hilbig2018]

@Kieslich2014: HEXACO factor Humility Honesty predicts cooperation
  @Hilbig2018: this link is explained by greed (temptation to exploit others' cooperation)
@Emonds2011: interaction pro-self/pro-social x type of game
@Liu2009a: independent vs interdependent self
@Probst1999: different patterns of cooperation based on culture (vertical individualist, vertical collectivist, HI, HC)
@Sussman2016: pro-env values predict less harvesting only when a resource is scarce
@VanLange1998: field study on commuting --> proself accord more importance to the perceived efficacy of the behaviour (= personal well-being) than prosocial + prosocial with high trust expressed significantly more preference for a common transport/carpooling than the other three groups
@DeKwaadsteniet2008: interaction between group size (un)certainity and SVO, and the self-restraining effect observed in prosocial under uncertainity condition is explained by the motive to have a maximal joint outcome (but not by equality, even if this motive is more important for prosocial than proself)
@Balliet2009: meta-analysis: SVO has a general positive effect on cooperation + 2 mediators = paid vs unpaid (in unpaid situations SVO effect was stronger) and take-some vs give-some dilemmas (in give-some SVO effect was stronger)
@Kocher2017: self control and risk aversion impact cooperation
