...
-   commons are gaining always more interest because they could be a solution --\> start from this and then say that SD could be useful to understand + lack of quantitative studies about cooperation in commons
    ...
    -   to make the link: list of papers that studied a common in a social dilemma perspective (ex: Hartl & Hofmann, 2022)
...
@Munn2018: reason to conduct a scoping review
...
Initially, 5210 papers emerged from the key phrases search. After deleting the duplicates, the count was of 4586. Based on titles and abstracts, 4321 articles were eliminated, leaving 253 texts to examine. After a full-text evaluation of the remaining papers, 92were selected for the present review. Figure 1 resumes this selection procedure.

## Papers' description

The included papers were published between 1984 and 2023, with a median of 2015.

A majority of the studies was conducted in Europe (*N*=40) (especially in Germany (*N*=12) and in the Netherlands (*N*=9)), followed by North America (*N*=20, of which *N*=19 in the USA) and Asia (*N*=10, of which *N*=7 in China). Moreover, *N*=7 studies were set in more than one country, and *N*=13 were meta-analysis or literature reviews. The two remaining studies took place in Australia and in Colombia, respectively.

Almost all of the selected texts were journal articles. The only exceptions were a conference paper and a book chapter.

still to do:

-   main topic: social dilemma or commons? social dilemma to conceptualize a specific commons? social dilemma applied to real-life situations?

-   methodology: lab vs meta-analysis vs review vs qualitative vs other?
...
60/92 papers in Europe and North America + reviews also based on studies in these countries =\> bias (talk about cultural differences in cooperation)
